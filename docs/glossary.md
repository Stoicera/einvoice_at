...
| **Bundesdienststellen** | Austrian federal government service units / agencies. The AT-B2G Schematron rule `AT-B2G-01` (`validation/src/main/resources/schematron/at-b2g-ebinterface-6.1.sch`, `SchematronRuleCatalog.java`) requires an Auftragsreferenz specifically for invoices addressed to Bundesdienststellen, per e-rechnung.gv.at's federal B2G obligation. |
